...
public class FXDeltaRequest extends com.clarusft.api.model.ApiRequest {
	public FXDeltaRequest() {
		super("Risk", "FXDelta", com.clarusft.api.http.OutputTypes.CSV, com.clarusft.api.http.HttpMethod.POST);
	}
	...
	public FXDeltaRequest withMarket(java.lang.String market) {
		setParameter("market", market);
		return this;
	}
	...
	public FXDeltaRequest withMarketData(java.util.Collection<String> marketData) {
		setParameter("marketData", marketData);
		return this;
	}
	...
	public FXDeltaRequest withMarketData(String... marketData) {
		setParameter("marketData", java.util.Arrays.asList(marketData));
		return this;
	}
	...
	public FXDeltaRequest withLadder(java.lang.String ladder) {
		setParameter("ladder", ladder);
		return this;
	}
	...
	public FXDeltaRequest withTenors(java.util.Collection<String> tenors) {
		setParameter("tenors", tenors);
		return this;
	}
	...
	public FXDeltaRequest withTenors(String... tenors) {
		setParameter("tenors", java.util.Arrays.asList(tenors));
		return this;
	}
	...
	public FXDeltaRequest withScenarios(java.util.Collection<String> scenarios) {
		setParameter("scenarios", scenarios);
		return this;
	}
	...
	public FXDeltaRequest withScenarios(String... scenarios) {
		setParameter("scenarios", java.util.Arrays.asList(scenarios));
		return this;
	}
	...
	public FXDeltaRequest withReportCcy(java.lang.String reportCcy) {
		setParameter("reportCcy", reportCcy);
		return this;
	}
	...
	public FXDeltaRequest withRow(java.lang.String row) {
		setParameter("row", row);
		return this;
	}
	...
	public FXDeltaRequest withCol(java.lang.String col) {
		setParameter("col", col);
		return this;
	}
	...
	public FXDeltaRequest withTotalRow(java.lang.Boolean totalRow) {
		setParameter("totalRow", totalRow);
		return this;
	}
	...
	public FXDeltaRequest withTotalCol(java.lang.Boolean totalCol) {
		setParameter("totalCol", totalCol);
		return this;
	}
