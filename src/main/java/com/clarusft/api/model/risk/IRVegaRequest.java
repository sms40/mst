...
public class IRVegaRequest extends com.clarusft.api.model.ApiRequest {
	public IRVegaRequest() {
		super("Risk", "IRVega", com.clarusft.api.http.OutputTypes.CSV, com.clarusft.api.http.HttpMethod.POST);
	}
	...
	public IRVegaRequest withPortfolios(java.util.Collection<String> portfolios) {
		setParameter("portfolios", portfolios);
		return this;
	}
	...
	public IRVegaRequest withPortfolios(String... portfolios) {
		setParameter("portfolios", java.util.Arrays.asList(portfolios));
		return this;
	}
	...
	public IRVegaRequest withWhatif(java.util.Collection<String> whatif) {
		setParameter("whatif", whatif);
		return this;
	}
	...
	public IRVegaRequest withWhatif(String... whatif) {
		setParameter("whatif", java.util.Arrays.asList(whatif));
		return this;
	}
	...
	public IRVegaRequest withValueDate(java.time.LocalDate valueDate) {
		setParameter("valueDate", valueDate);
		return this;
	}
	...
	public IRVegaRequest withMarket(java.lang.String market) {
		setParameter("market", market);
		return this;
	}
	...
	public IRVegaRequest withMarketData(java.util.Collection<String> marketData) {
		setParameter("marketData", marketData);
		return this;
	}
	...
	public IRVegaRequest withMarketData(String... marketData) {
		setParameter("marketData", java.util.Arrays.asList(marketData));
		return this;
	}
	...
	public IRVegaRequest withScenarios(java.util.Collection<String> scenarios) {
		setParameter("scenarios", scenarios);
		return this;
	}
	...
	public IRVegaRequest withScenarios(String... scenarios) {
		setParameter("scenarios", java.util.Arrays.asList(scenarios));
		return this;
	}
	...
	public IRVegaRequest withReportCcy(java.lang.String reportCcy) {
		setParameter("reportCcy", reportCcy);
		return this;
	}
	...
	public IRVegaRequest withRow(java.lang.String row) {
		setParameter("row", row);
		return this;
	}
	...
	public IRVegaRequest withCol(java.lang.String col) {
		setParameter("col", col);
		return this;
	}
	...
	public IRVegaRequest withTotalRow(java.lang.Boolean totalRow) {
		setParameter("totalRow", totalRow);
		return this;
	}
	...
	public IRVegaRequest withTotalCol(java.lang.Boolean totalCol) {
		setParameter("totalCol", totalCol);
		return this;
	}
