...
public class SAImpactRequest extends com.clarusft.api.model.ApiRequest {
	...
	public SAImpactRequest withNotionalSizes(java.util.Collection<String> notionalSizes) {
		setParameter("notionalSizes", notionalSizes);
		return this;
	}
	...
	public SAImpactRequest withNotionalSizes(String... notionalSizes) {
		setParameter("notionalSizes", java.util.Arrays.asList(notionalSizes));
		return this;
	}
	...
	public SAImpactRequest withDv01Sizes(java.util.Collection<String> dv01Sizes) {
		setParameter("dv01Sizes", dv01Sizes);
		return this;
	}
	...
	public SAImpactRequest withDv01Sizes(String... dv01Sizes) {
		setParameter("dv01Sizes", java.util.Arrays.asList(dv01Sizes));
		return this;
	}
